...
注意：使用本主题请仔细查看[This 主题：Ji wen](https://github.com/GanJS)，

没有使用过Hexo的同学可以看看[GitHub This搭建](https://github.com/GanJS)，另外还有一个我自己搭建时，插件的安装教程[Hexo插件安装](http://luuman.github.io/categories/Hexo/)
...
```
## If your site is put in a subdirectory, set url as 'https://github.com/GanJS' and root as '/child/'
url: https://github.com/GanJS
root: /GanJS/
# url: https://github.com/GanJS
# root: /
```
